  ...
  return (
    <div className="popupenter">
      <div className="popup-inner">
        <h2>Welcome to Transport Planner Challenge 1 </h2>
...
function Calendar() {
  ...
  return (
    <div style={{ color: "#3366ff", fontFamily: "arial" }} align="center">
      ...
      <div>
        <div style={{ border: "2px solid blue", width: "1000px", margin: "auto", padding: "10px", fontWeight: 'normal' }}>
          <span style={{ textDecoration: "underline" }}>Instructions:</span>
          <br />
          <br />
          <span style={{ fontWeight: 'bolder' }}>1. Find your transport:</span> <span style={{ textDecoration: "underline" }}>Hover your mouse</span> over images to see each transport type.
          <br />
          <span style={{ fontWeight: 'bolder' }}>2. Enter your data:</span> <span style={{ textDecoration: "underline" }}>Right click images</span> on right to enter the data for each travel type.
          <br />
          <span style={{ fontWeight: 'bolder' }}>3. Place your images:</span> <span style={{ textDecoration: "underline" }}>Drag your image</span> to the month you travelled, you can also drag trips between months.
          <br />
          <span style={{ fontWeight: 'bolder' }}> 4. Undo your data:</span> <span style={{ textDecoration: "underline" }}>Click the undo button on the month</span> to remove your most recent transport choice.
          <br />
          <span style={{ fontWeight: 'bolder' }}>5.Track your progress:</span> <span style={{ textDecoration: "underline" }}>The progress bar</span> will display your progress against the national average.
        </div>
        <br />
        <br />
        ...
        <span style={{ fontSize: '16px', fontWeight: 'bold' }}>KG / 2,500KG (National Average)</span>
        <br />
